%% File: hipe_literals.hrl, generated by /home/jok/.kerl/builds/21.0/otp_src_21.0/bin/x86_64-unknown-linux-gnu/hipe_mkliterals.smp
...
-define(ERTS_USE_LITERAL_TAG, hipe_bifs:get_rts_param(17)).
...
-define(P_GCUNSAFE, hipe_bifs:get_rts_param(53)).
-define(P_MSG_LAST, hipe_bifs:get_rts_param(54)).
-define(P_MSG_SAVED_LAST, hipe_bifs:get_rts_param(55)).

-define(HIPE_LITERALS_CRC, 122678986).
